		...
		<?php endif; ?>
					...
					<?php if ( ! has_custom_logo() ) { ?>
						...
						<?php if ( is_front_page() && is_home() ) : ?>
							...
							<h1 class="navbar-brand mb-0 nav-small"><a rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" itemprop="url"><?php bloginfo( 'description' ); ?></a></h1>
